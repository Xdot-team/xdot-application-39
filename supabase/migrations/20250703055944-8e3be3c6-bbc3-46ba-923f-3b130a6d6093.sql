...
CREATE INDEX IF NOT EXISTS idx_head_office_tasks_status ON public.head_office_tasks(status);
CREATE INDEX IF NOT EXISTS idx_head_office_tasks_assignee ON public.head_office_tasks(assignee_id);
CREATE INDEX IF NOT EXISTS idx_front_desk_logs_type ON public.front_desk_logs(type);
CREATE INDEX IF NOT EXISTS idx_front_desk_logs_created_at ON public.front_desk_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_system_settings_category ON public.system_settings(category);
CREATE INDEX IF NOT EXISTS idx_kickoff_meetings_status ON public.kickoff_meetings(status);
CREATE INDEX IF NOT EXISTS idx_kickoff_meetings_date ON public.kickoff_meetings(date);
