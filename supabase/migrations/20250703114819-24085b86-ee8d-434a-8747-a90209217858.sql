-- Phase 1: Database Schema Completion for Organization and Safety Modules (Fixed)
...
CREATE INDEX IF NOT EXISTS idx_organization_reports_created_by ON public.organization_reports(created_by_name);
