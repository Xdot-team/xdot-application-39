-- Create comprehensive admin module database schema with proper indexes
...
-- Performance indexes
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_posts_category ON public.forum_posts(category);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_posts_created_at ON public.forum_posts(created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_forum_replies_post_id ON public.forum_replies(post_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_head_office_tasks_status ON public.head_office_tasks(status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_head_office_tasks_assignee ON public.head_office_tasks(assignee_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_front_desk_logs_type ON public.front_desk_logs(type);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_front_desk_logs_created_at ON public.front_desk_logs(created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_system_settings_category ON public.system_settings(category);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_kickoff_meetings_status ON public.kickoff_meetings(status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_kickoff_meetings_date ON public.kickoff_meetings(date);
...
-- Create RLS policies for head_office_tasks
DROP POLICY IF EXISTS "Allow all operations on head_office_tasks" ON public.head_office_tasks;
...
DROP POLICY IF EXISTS "Allow all operations on front_desk_logs" ON public.front_desk_logs;
...
DROP POLICY IF EXISTS "Anyone can view public appreciations" ON public.employee_appreciations;
DROP POLICY IF EXISTS "Users can view appreciations they sent or received" ON public.employee_appreciations;
DROP POLICY IF EXISTS "Authenticated users can create appreciations" ON public.employee_appreciations;
DROP POLICY IF EXISTS "Users can update their own appreciations" ON public.employee_appreciations;
...
DROP POLICY IF EXISTS "Allow all operations on kickoff_meetings" ON public.kickoff_meetings;
...
DROP POLICY IF EXISTS "Allow all operations on meeting_attendees" ON public.meeting_attendees;
...
DROP POLICY IF EXISTS "Allow all operations on agenda_items" ON public.agenda_items;
...
DROP POLICY IF EXISTS "Allow all operations on action_items" ON public.action_items;
...
DROP POLICY IF EXISTS "Allow all operations on api_configurations" ON public.api_configurations;
...
DROP TRIGGER IF EXISTS update_head_office_tasks_updated_at ON public.head_office_tasks;
DROP TRIGGER IF EXISTS update_system_settings_updated_at ON public.system_settings;
DROP TRIGGER IF EXISTS update_kickoff_meetings_updated_at ON public.kickoff_meetings;
